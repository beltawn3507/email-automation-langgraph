...
class Agents:
    def __init__(self):
        ...
        threat_screen_prompt = PromptTemplate(
            template=THREAT_SCREEN_PROMPT,
            input_variables=["email"]
        )
        self.screen_for_threats = (
            threat_screen_prompt
            | llm.with_structured_output(ThreatScreenOutput, method="json_schema")
        )
